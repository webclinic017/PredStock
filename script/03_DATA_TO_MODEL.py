...
xgb_options = [
    ...
    {'max_depth' : 7, 'ag_args_fit': {'num_gpus': 1}, 'tree_method': 'gpu_hist', 'ag_args': {'name_suffix': 'A'}},
    {'max_depth' : 9, 'ag_args_fit': {'num_gpus': 1}, 'tree_method': 'gpu_hist', 'ag_args': {'name_suffix': 'B'}},
]
...
plt.hist(df_te_new.groupby("DATE").apply(get_best)['RATE2'], bins=20, alpha = 0.5, range = (-0.3,0.3))
plt.hist(df_te_pre.groupby("DATE").apply(get_best)['RATE2'], bins=20, alpha = 0.5, range = (-0.3,0.3))
